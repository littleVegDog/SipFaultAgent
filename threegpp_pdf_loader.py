...
def extract_text_from_pdf_with_docling(pdf_path: str) -> str:
    """使用Docling从PDF提取结构化文本（含OCR支持）"""
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    # 指定模型路径
    easyocr_model_storage_directory = os.path.join(BASE_DIR, "model_files", "docling_models", "easyocr")
    # 指定OCR模型
    ...
    artifacts_path = os.path.join(BASE_DIR, "model_files", "docling_models", "docling-models")
